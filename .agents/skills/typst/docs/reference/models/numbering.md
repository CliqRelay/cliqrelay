...
The _ character means that symbols should be used to count, in the order of _, †, ‡, §, ¶, ‖. If there are more than six items, the number is represented using repeated symbols.
