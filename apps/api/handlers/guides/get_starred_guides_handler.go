...
func NewGetStarredGuidesHandler(guidesUseCase interfaces.GuidesUseCase) *GetStarredGuidesHandler {
	return &GetStarredGuidesHandler{guidesUseCase: guidesUseCase}
}
