...
func NewPermanentlyDeleteGuideHandler(guidesUseCase interfaces.GuidesUseCase) *PermanentlyDeleteGuideHandler {
	return &PermanentlyDeleteGuideHandler{guidesUseCase: guidesUseCase}
}
