...
func NewUpdateGuideHandler(appConfig *config.AppConfig, guidesUseCase interfaces.GuidesUseCase) *UpdateGuideHandler {
	return &UpdateGuideHandler{appConfig: appConfig, guidesUseCase: guidesUseCase}
}
