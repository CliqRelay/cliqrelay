...
func NewCreateMediaAssetHandler(mediaAssetsUseCase interfaces.MediaAssetsUseCase) *CreateMediaAssetHandler {
	return &CreateMediaAssetHandler{mediaAssetsUseCase: mediaAssetsUseCase}
}
