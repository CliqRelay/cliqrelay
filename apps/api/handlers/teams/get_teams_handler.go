...
func (h *GetTeamsHandler) Handle() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Preallocated so an empty result marshals as [] rather than null: the
		// OpenAPI contract declares teams as required and non-nullable, and the
		// web app calls .filter() on it directly.
