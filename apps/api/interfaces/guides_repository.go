...
type GuidesRepository interface {
	...
	Unpublish(ctx context.Context, id string) (*models.Guide, error)
	Archive(ctx context.Context, id string) (*models.Guide, error)
	Unarchive(ctx context.Context, id string) (*models.Guide, error)
	Restore(ctx context.Context, id string) (*models.Guide, error)
	PermanentlyDelete(ctx context.Context, id string) (*models.Guide, error)
