...
type MediaAssetHooks struct {
	BeforeCreate func(ctx context.Context, actor *authulamodels.Actor, workspaceID string, req *types.CreateMediaAssetRequest) error
	AfterCreate  func(ctx context.Context, actor *authulamodels.Actor, asset *models.MediaAsset) error
	BeforeUpdate func(ctx context.Context, actor *authulamodels.Actor, workspaceID string, req *types.UpdateMediaAssetRequest) error
