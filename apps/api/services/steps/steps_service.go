...
func (s *StepsService) Create(ctx context.Context, req *types.CreateStepRequest) (*models.Step, error) {
	...
	guide, err := s.getGuideForStep(ctx, identity, req.GuideID.String())
	if err != nil {
		return nil, err
	}
	...
	if s.hooks != nil && s.hooks.AfterCreate != nil {
		if err := s.hooks.AfterCreate(ctx, identity, step); err != nil {
			return nil, err
		}
	}
...
func (s *StepsService) GetByID(ctx context.Context, stepID string) (*models.Step, error) {
	...
	guide, err := s.getGuideForStep(ctx, identity, step.GuideID.String())
	if err != nil {
		return nil, err
	}
...
func (s *StepsService) GetByGuideID(ctx context.Context, guideID string) ([]*models.Step, error) {
	...
	guide, err := s.getGuideForStep(ctx, identity, guideID)
	if err != nil {
		return nil, err
	}
...
func (s *StepsService) Delete(ctx context.Context, stepID string) error {
	...
	if s.hooks != nil && s.hooks.BeforeDelete != nil {
		if err := s.hooks.BeforeDelete(ctx, identity, step); err != nil {
			return err
		}
	}
	...
	if s.hooks != nil && s.hooks.AfterDelete != nil {
		if err := s.hooks.AfterDelete(ctx, identity, stepID); err != nil {
			return err
		}
	}
...
func (s *StepsService) Duplicate(ctx context.Context, stepID string, req *types.DuplicateStepRequest) (*models.Step, error) {
	...
	guide, err := s.getGuideForStep(ctx, identity, original.GuideID.String())
	if err != nil {
		return nil, err
	}
...
func (s *StepsService) getGuideForStep(ctx context.Context, ident *models.Identity, guideID string) (*models.Guide, error) {
