...
type options struct {
	...
	activityLogsRepo  interfaces.ActivityLogsRepository
...
func WithActivityLogsRepository(repo interfaces.ActivityLogsRepository) Option {
	return func(o *options) { o.activityLogsRepo = repo }
}
