...
func NewUnarchiveGuideHandler(appConfig *internal.AppConfig, guidesService *guidesservice.GuidesService) *UnarchiveGuideHandler {
...
func (h *UnarchiveGuideHandler) Handle() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		guide, err := h.guidesService.Unarchive(ctx, reqCtx.Actor.ID, guideID)
		if err != nil {
