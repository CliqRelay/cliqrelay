...
import (
	...
	"github.com/CliqRelay/cliqrelay/internal/handlers/steps"
	...
	stepsservices "github.com/CliqRelay/cliqrelay/internal/services/steps"
	"github.com/CliqRelay/cliqrelay/internal/services/storage"
	"github.com/CliqRelay/cliqrelay/internal/types"
)

func StepsRoutes(appConfig *internal.AppConfig) []authulamodels.Route {
