	...
	const routes = rootRoute("__root.tsx", [
		...
		route("/dashboard", "dashboard/route.tsx", [
			...
			route("/organizations", [
				route(
					"/$orgId/settings",
					"dashboard/organizations/$orgId/settings/route.tsx",
					[
						index("dashboard/organizations/$orgId/settings/index.tsx"),
						route(
							"/general",
							"dashboard/organizations/$orgId/settings/general/index.tsx",
						),
						route(
							"/members",
							"dashboard/organizations/$orgId/settings/members/index.tsx",
						),
						route(
							"/teams",
							"dashboard/organizations/$orgId/settings/teams/index.tsx",
						),
						route(
							"/branding",
				...
				route(
					"/$orgId/teams/$teamId/settings",
					"dashboard/organizations/$orgId/teams/$teamId/settings/route.tsx",
					[
						index(
							"dashboard/organizations/$orgId/teams/$teamId/settings/index.tsx",
						),
						route(
							"/general",
							"dashboard/organizations/$orgId/teams/$teamId/settings/general/index.tsx",
						),
						route(
							"/members",
							"dashboard/organizations/$orgId/teams/$teamId/settings/members/index.tsx",
						),
					],
				),
